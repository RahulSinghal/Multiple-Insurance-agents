...
try:
    ...
    # Verify table exists
    cur.execute("SELECT EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'customer_insurance')")
    ...
    collection = Collection("insurance_customers")  # Should verify collection exists
